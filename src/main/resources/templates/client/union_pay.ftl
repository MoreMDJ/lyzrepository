...
<html>
	...
	<body style="height: 100%; background: #f3f4f6;">
		<div>
  		...
  		<form action="" method="post" name="MD5form" id="MD5form" target="_blank">
			...
			<input class="sub" name="sendB" type="button" id="sendB" onClick="go(window.MD5form.result.value)" value="请确认支付" />
		</form>
	</body>
</html>